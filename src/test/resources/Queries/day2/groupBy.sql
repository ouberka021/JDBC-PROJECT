...
SELECT * FROM EMPLOYEES;
SELECT DEPARTMENT_ID,SUM(SALARY) AS TOTAL_SALARY,COUNT(*) AS NUMBER_OF_EMPLOYEES
FROM EMPLOYEES GROUP BY DEPARTMENT_ID ORDER BY COUNT(*) DESC;

SELECT * FROM EMPLOYEES;
SELECT DEPARTMENT_ID,SUM(SALARY) AS TOTAL_SALARY,COUNT(*) AS NUMBER_OF_EMPLOYEES
FROM EMPLOYEES WHERE DEPARTMENT_ID IS NOT NULL GROUP BY DEPARTMENT_ID  ORDER BY COUNT(*) DESC  ;
